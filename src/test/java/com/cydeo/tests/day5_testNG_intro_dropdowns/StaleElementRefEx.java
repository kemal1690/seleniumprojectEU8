...
public class StaleElementRefEx {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //button[@onclick='addElement()']
         ...
         Thread.sleep(2000);//This is just for seing the action
        addElementBtn.click();
      ...
      try{
          System.out.println("deleteButton.isDisplayed() = " + deleteButton.isDisplayed());
          // gives StaleElementReferenceException.Because when we click deletebutton it disappears
          //and our driver can not find it again.We can not relocate either, it's beeen deleted from the page
