...
public class T1_DoubleClick {
    ...
    public void t1_double_click_test() {
        ...
        Driver.getDriver().switchTo().frame("iframeResult");//iframeResult = iframe id value
        //3 way to locate iframe, id or name values, index, or web element

        //3. Double-click on the text “Double-click me to change my text color.”
        DoubleClickPage doubleClickPage = new DoubleClickPage();

        Actions actions = new Actions(Driver.getDriver());
        //Double click is possible with the Action class
        //if we write click().click()--> it doesnt work
