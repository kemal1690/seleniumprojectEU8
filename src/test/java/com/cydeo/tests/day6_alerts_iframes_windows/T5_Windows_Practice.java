...
public class T5_Windows_Practice {
    ...
    public void multiple_window_test(){
        ...
        System.out.println("mainHandle = " + mainWindowHandle);
        ...
        driver.switchTo().window(mainWindowHandle);//Selenium looks back to main window
        System.out.println("currentTitleAfterReturn = " + driver.getTitle());
